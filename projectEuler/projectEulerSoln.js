...
function evenValuedFibNumSum() {
    ...
    var firstNum = 0, secondNum = 1, nextNum = 0, sumOfEvenValuedTerms = 0;
...
exports.evenValuedFibNumSum = evenValuedFibNumSum;
...
function greatestPrime() {
    ...
    var quotient = 600851475143, divisor = 2;
...
exports.greatestPrime = greatestPrime;
...
function palindrom3DigitMultiple() {
    ...
    var largestPalin = 0, toReverse, reversedProduct, product;
...
exports.palindrom3DigitMultiple = palindrom3DigitMultiple;
function smallestMultipleOf1To20() {
    console.log("smallestMultipleOf1To20");
    var primeNumberBelow20 = [], sieveArray = [], smallestMultiple = 1, largestPrimePower, isPrime = true, upperLimit = Math.sqrt(20);
    for (var i = 0; i < 21; i++) {
        sieveArray.push(i);
    }
    ...
    primeNumberBelow20.forEach(function (prime) {
...
exports.smallestMultipleOf1To20 = smallestMultipleOf1To20;
function squaredSumMinusSumOfSquared() {
    console.log("Square of sum of 1-100 minus sum of square of 1 to 100");
    var squaredSum = 0, sum = 0, sumOfSquared = 0, difference;
    for (var i = 1; i < 101; i++) {
        sum += i;
        sumOfSquared += i * i;
    }
...
exports.squaredSumMinusSumOfSquared = squaredSumMinusSumOfSquared;
function prime10001st() {
    console.log("10001st Prime");
    var count = 1, // number "2" will contribute to the first count.
    isPrime;
...
exports.prime10001st = prime10001st;
...
exports.pythagorasTripletsProduct = pythagorasTripletsProduct;
function sumOfPrimeBelow2Mil() {
    console.log("sum of all prime below 2 million");
    var isPrime, primeSum = 2;
    ...
    var numArray = [], primeSum2 = 0, upperLimit = Math.sqrt(2000000);
...
exports.sumOfPrimeBelow2Mil = sumOfPrimeBelow2Mil;
